Introduction
This portfolio is a single-page website that provides an overview of my skills, projects, and how to get in touch with me. It is designed to be clean, professional, and responsive, making it easy to view on various devices.
